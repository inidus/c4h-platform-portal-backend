...
import cloud.c4h.platform.repository.search.UserSearchRepository;
import cloud.c4h.platform.security.AuthoritiesConstants;
import cloud.c4h.platform.security.SecurityUtils;
import cloud.c4h.platform.service.dto.UserDTO;
import cloud.c4h.platform.service.util.RandomUtil;
...
public class UserService {
    ...
    public Optional<User> activateRegistration(String key) {
        ...
        Optional<User> foundUser = userRepository.findOneByActivationKey(key);
