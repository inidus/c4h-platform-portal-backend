...
import cloud.operon.platform.config.Constants;
import cloud.operon.platform.domain.Authority;
import cloud.operon.platform.repository.AuthorityRepository;
import cloud.operon.platform.repository.UserRepository;
import cloud.operon.platform.repository.search.UserSearchRepository;
...
import cloud.operon.platform.service.util.RandomUtil;
